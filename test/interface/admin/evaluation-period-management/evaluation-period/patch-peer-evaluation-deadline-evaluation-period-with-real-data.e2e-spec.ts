...
describe('PATCH /admin/evaluation-periods/:id/peer-evaluation-deadline - 실제 데이터 기반', () => {
  ...
  describe('시나리오 1: 성공 케이스', () => {
    it('동료평가 마감일을 수정해야 한다', async () => {
      ...
      if (periods.length > 0) {
        ...
        const updateData = {
          peerEvaluationDeadline: newDeadline.toISOString().split('T')[0],
        };
