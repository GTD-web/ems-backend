/**
 * 자기평가 설정 권한 수정 - 실제 데이터 기반 E2E 테스트
 */
...
describe('PATCH /admin/evaluation-periods/:id/settings/self-evaluation-permission - 실제 데이터 기반', () => {
  ...
  describe('시나리오 1: 성공 케이스', () => {
    it('자기평가 설정 수동 허용을 변경해야 한다', async () => {
