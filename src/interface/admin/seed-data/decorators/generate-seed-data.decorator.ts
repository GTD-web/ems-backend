    ...
    ApiBody({
      ...
      examples: {
        ...
        fullPrimaryOnly: {
          ...
          description:
            '자기평가 + 1차 하향평가 완료, 2차/동료/최종평가 미작성 (직원 10명)',
          value: {
            scenario: 'full',
            clearExisting: true,
            dataScale: {
        ...
        fullSecondaryComplete: {
          ...
          description:
            '자기/1차/2차 하향/동료평가 완료, 최종평가 미작성 (직원 10명)',
          value: {
            scenario: 'full',
            clearExisting: true,
            dataScale: {
        ...
        customExclusion: {
          summary: '10. CUSTOM (직원 제외) - 제외 대상자 10%/15% 테스트',
          description: '직원 제외 상태 테스트 (조회 제외 10%, 평가 제외 15%)',
          value: {
            scenario: 'full',
            clearExisting: true,
            dataScale: {
