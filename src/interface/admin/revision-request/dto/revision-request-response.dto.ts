...
export class EvaluationPeriodInfoDto {
  @ApiProperty({ description: '평가기간 ID', example: '123e4567-e89b-12d3-a456-426614174000' })
  id: string;
...
export class RevisionRequestResponseDto {
  // ==================== 기본 정보 ====================
  @ApiProperty({ description: '재작성 요청 ID', example: '123e4567-e89b-12d3-a456-426614174000' })
  requestId: string;
  ...
  @ApiProperty({ description: '요청자 ID', example: '123e4567-e89b-12d3-a456-426614174000' })
  requestedBy: string;

  @ApiProperty({ description: '요청 일시', example: '2024-01-01T00:00:00.000Z' })
  requestedAt: Date;

  // ==================== 수신자 정보 ====================
  @ApiProperty({ description: '수신자 ID', example: '123e4567-e89b-12d3-a456-426614174000' })
  recipientId: string;
  ...
  @ApiPropertyOptional({ description: '읽은 일시', nullable: true, example: '2024-01-01T00:00:00.000Z' })
  readAt: Date | null;

  @ApiProperty({ description: '재작성 완료 여부', example: false })
  isCompleted: boolean;

  @ApiPropertyOptional({ description: '재작성 완료 일시', nullable: true, example: '2024-01-01T00:00:00.000Z' })
