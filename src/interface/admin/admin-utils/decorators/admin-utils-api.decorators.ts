...
/**
 * 모든 WBS 평가기준 리셋 API 데코레이터
 */
export function ResetAllWbsEvaluationCriteria() {
  return applyDecorators(
    Post('wbs-evaluation-criteria/reset'),
    HttpCode(HttpStatus.OK),
    ApiOperation({
 ...
 * 모든 산출물 리셋 API 데코레이터
 */
export function ResetAllDeliverables() {
  return applyDecorators(
    Post('deliverables/reset'),
    HttpCode(HttpStatus.OK),
    ApiOperation({
      summary: '모든 산출물 리셋',
...
/**
 * 모든 프로젝트 할당 리셋 API 데코레이터
 */
export function ResetAllProjectAssignments() {
  return applyDecorators(
    Post('project-assignments/reset'),
    HttpCode(HttpStatus.OK),
    ApiOperation({
...
/**
 * 모든 평가라인 리셋 API 데코레이터
 */
export function ResetAllEvaluationLines() {
  return applyDecorators(
    Post('evaluation-lines/reset'),
    HttpCode(HttpStatus.OK),
    ApiOperation({
      summary: '모든 평가라인 리셋',
