...
export declare class EvaluationRevisionRequestService implements IEvaluationRevisionRequestService {
    private readonly revisionRequestRepository;
    private readonly recipientRepository;
    private readonly logger;
    constructor(revisionRequestRepository: Repository<EvaluationRevisionRequest>, recipientRepository: Repository<EvaluationRevisionRequestRecipient>);
