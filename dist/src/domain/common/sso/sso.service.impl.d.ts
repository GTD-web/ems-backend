...
export declare class SSOServiceImpl implements ISSOService, OnModuleInit {
    private readonly config;
    private readonly injectedSystemName;
    private readonly injectedEnableJsonStorage?;
    private readonly logger;
    private readonly sdkClient;
    private readonly systemName;
    private initialized;
    private readonly enableJsonStorage;
    constructor(config: any, injectedSystemName: string, injectedEnableJsonStorage?: boolean | undefined);
