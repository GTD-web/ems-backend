import { ChangePasswordResult, CheckPasswordResult, DepartmentHierarchy, EmployeeInfo, FCMTokenInfo, GetDepartmentHierarchyParams, GetEmployeeParams, GetEmployeesManagersResponse, GetEmployeesParams, GetFCMTokenParams, GetMultipleFCMTokensParams, LoginResult, MultipleFCMTokensInfo, RefreshTokenResult, SubscribeFCMParams, SubscribeFCMResult, UnsubscribeFCMParams, UnsubscribeFCMResult, VerifyTokenResult } from './index';
export interface ISSOService {
    ...
    모든부서정보를조회한다(params?: GetDepartmentHierarchyParams): Promise<import('./sso-organization.interface').DepartmentInfo[]>;
