...
let WbsAssignmentBusinessService = WbsAssignmentBusinessService_1 = class WbsAssignmentBusinessService {
    ...
    async 평가라인을_자동으로_구성한다(employeeId, wbsItemId, projectId, periodId, createdBy) {
        ...
        console.log(...oo_oo(`3677446355_903_4_908_6_4`, '🔍 직원 정보:', {
            id: employee.id,
            name: employee.name,
        ...
        console.log(...oo_oo(`3677446355_917_4_921_6_4`, '🔍 프로젝트 정보:', {
            id: project.id,
            name: project.name,
        ...
        if (projectManagerId) {
            if (projectManagerId !== employee.managerId) {
                ...
                await this.evaluationCriteriaManagementService.이차_평가자를_구성한다(employeeId, wbsItemId, periodId, projectManagerId, createdBy);
            }
            else {
