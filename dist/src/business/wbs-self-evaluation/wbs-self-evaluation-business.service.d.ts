...
export declare class WbsSelfEvaluationBusinessService {
    ...
    constructor(performanceEvaluationService: PerformanceEvaluationService, revisionRequestContextService: RevisionRequestContextService, stepApprovalContextService: StepApprovalContextService, commandBus: CommandBus);
