...
exports.GetAllEmployeesFinalEvaluationsHandler = exports.GetAllEmployeesFinalEvaluationsQuery = void 0;
...
class GetAllEmployeesFinalEvaluationsQuery {
    startDate;
    endDate;
...
exports.GetAllEmployeesFinalEvaluationsQuery = GetAllEmployeesFinalEvaluationsQuery;
let GetAllEmployeesFinalEvaluationsHandler = class GetAllEmployeesFinalEvaluationsHandler {
    finalEvaluationRepository;
    employeeRepository;
    evaluationPeriodRepository;
    evaluationPeriodEmployeeMappingRepository;
    constructor(finalEvaluationRepository, employeeRepository, evaluationPeriodRepository, evaluationPeriodEmployeeMappingRepository) {
    ...
    async execute(query) {
        ...
        const queryBuilder = this.finalEvaluationRepository
            ...
            .leftJoin(evaluation_period_employee_mapping_entity_1.EvaluationPeriodEmployeeMapping, 'mapping', '"mapping"."evaluationPeriodId"::UUID = "finalEvaluation"."periodId"::UUID AND "mapping"."employeeId"::UUID = "finalEvaluation"."employeeId"::UUID AND "mapping"."deletedAt" IS NULL')
            .where('finalEvaluation.deletedAt IS NULL')
            .andWhere('("mapping"."isExcluded" IS NULL OR "mapping"."isExcluded" = false)');
        if (startDate) {
...
exports.GetAllEmployeesFinalEvaluationsHandler = GetAllEmployeesFinalEvaluationsHandler;
exports.GetAllEmployeesFinalEvaluationsHandler = GetAllEmployeesFinalEvaluationsHandler = __decorate([
    (0, common_1.Injectable)(),
    (0, cqrs_1.QueryHandler)(GetAllEmployeesFinalEvaluationsQuery),
...
//# sourceMappingURL=get-all-employees-final-evaluations.query.js.map