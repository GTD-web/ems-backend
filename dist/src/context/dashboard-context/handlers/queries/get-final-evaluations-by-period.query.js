...
exports.GetFinalEvaluationsByPeriodHandler = exports.GetFinalEvaluationsByPeriodQuery = void 0;
...
class GetFinalEvaluationsByPeriodQuery {
    evaluationPeriodId;
    constructor(evaluationPeriodId) {
        this.evaluationPeriodId = evaluationPeriodId;
    }
}
exports.GetFinalEvaluationsByPeriodQuery = GetFinalEvaluationsByPeriodQuery;
let GetFinalEvaluationsByPeriodHandler = class GetFinalEvaluationsByPeriodHandler {
    finalEvaluationRepository;
    employeeRepository;
    mappingRepository;
    evaluationPeriodRepository;
    constructor(finalEvaluationRepository, employeeRepository, mappingRepository, evaluationPeriodRepository) {
    ...
    async execute(query) {
        ...
        const rawResults = await this.finalEvaluationRepository
            ...
            .leftJoin(evaluation_period_employee_mapping_entity_1.EvaluationPeriodEmployeeMapping, 'mapping', 'mapping."employeeId"::UUID = "finalEvaluation"."employeeId"::UUID AND mapping."evaluationPeriodId"::UUID = "finalEvaluation"."periodId"::UUID AND mapping.deletedAt IS NULL')
...
exports.GetFinalEvaluationsByPeriodHandler = GetFinalEvaluationsByPeriodHandler;
exports.GetFinalEvaluationsByPeriodHandler = GetFinalEvaluationsByPeriodHandler = __decorate([
    (0, common_1.Injectable)(),
    (0, cqrs_1.QueryHandler)(GetFinalEvaluationsByPeriodQuery),
...
//# sourceMappingURL=get-final-evaluations-by-period.query.js.map