...
export declare class ClearSeedDataCommand {
    readonly scenario?: SeedScenario | undefined;
    constructor(scenario?: SeedScenario | undefined);
}
export declare class ClearSeedDataHandler implements ICommandHandler<ClearSeedDataCommand, void> {
    ...
    execute(command: ClearSeedDataCommand): Promise<void>;
    private clearPhase1;
    private clearPhase2;
    private clearPhase3;
    private clearPhase4;
