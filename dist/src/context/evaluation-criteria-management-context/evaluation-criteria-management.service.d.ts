...
export declare class EvaluationCriteriaManagementService implements IEvaluationCriteriaManagementService {
    ...
    constructor(commandBus: CommandBus, queryBus: QueryBus, evaluationLineMappingRepository: Repository<EvaluationLineMapping>, evaluationLineRepository: Repository<EvaluationLine>, employeeRepository: Repository<Employee>, evaluationPeriodEmployeeMappingRepository: Repository<EvaluationPeriodEmployeeMapping>, wbsAssignmentValidationService: WbsAssignmentValidationService);
    ...
    평가기간_전체_할당을_리셋한다(periodId: string, resetBy: string): Promise<ResetPeriodAssignmentsResult>;
    모든_프로젝트_할당을_삭제한다(deletedBy: string): Promise<DeleteAllProjectAssignmentsResult>;
