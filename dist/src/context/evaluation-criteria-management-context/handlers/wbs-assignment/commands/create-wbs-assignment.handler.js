...
exports.CreateWbsAssignmentHandler = exports.CreateWbsAssignmentCommand = void 0;
...
class CreateWbsAssignmentCommand {
    data;
    assignedBy;
...
exports.CreateWbsAssignmentCommand = CreateWbsAssignmentCommand;
let CreateWbsAssignmentHandler = class CreateWbsAssignmentHandler {
    dataSource;
    ...
    async execute(command) {
        ...
        return await this.dataSource.transaction(async (manager) => {
            ...
            await this.weightCalculationService.직원_평가기간_가중치를_재계산한다(data.employeeId, data.periodId, manager);
            return assignment.DTO로_변환한다();
        });
    }
};
exports.CreateWbsAssignmentHandler = CreateWbsAssignmentHandler;
exports.CreateWbsAssignmentHandler = CreateWbsAssignmentHandler = __decorate([
    (0, cqrs_1.CommandHandler)(CreateWbsAssignmentCommand),
...
//# sourceMappingURL=create-wbs-assignment.handler.js.map