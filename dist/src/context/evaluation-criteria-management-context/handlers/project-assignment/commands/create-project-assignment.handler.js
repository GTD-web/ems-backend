...
class CreateProjectAssignmentCommand {
    data;
    assignedBy;
    constructor(data, assignedBy) {
        this.data = data;
        this.assignedBy = assignedBy;
    }
}
exports.CreateProjectAssignmentCommand = CreateProjectAssignmentCommand;
let CreateProjectAssignmentHandler = class CreateProjectAssignmentHandler {
    ...
    async execute(command) {
        ...
        return await this.transactionManager.executeTransaction(async (manager) => {
            ...
            if (!project) {
                throw new common_1.NotFoundException(`프로젝트 ID ${data.projectId}에 해당하는 프로젝트를 찾을 수 없습니다.`);
            }
            ...
            if (evaluationPeriod.완료된_상태인가()) {
                throw new common_1.UnprocessableEntityException('완료된 평가기간에는 프로젝트 할당을 생성할 수 없습니다.');
            }
...
exports.CreateProjectAssignmentHandler = CreateProjectAssignmentHandler;
exports.CreateProjectAssignmentHandler = CreateProjectAssignmentHandler = __decorate([
    (0, cqrs_1.CommandHandler)(CreateProjectAssignmentCommand),
...
//# sourceMappingURL=create-project-assignment.handler.js.map