...
export declare class DeleteAllProjectAssignmentsCommand {
    readonly deletedBy: string;
    constructor(deletedBy: string);
}
export declare class DeleteAllProjectAssignmentsHandler implements ICommandHandler<DeleteAllProjectAssignmentsCommand> {
    ...
    execute(command: DeleteAllProjectAssignmentsCommand): Promise<DeleteAllProjectAssignmentsResult>;
}
