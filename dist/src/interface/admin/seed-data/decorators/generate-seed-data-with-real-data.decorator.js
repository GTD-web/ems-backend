...
exports.ApiGenerateSeedDataWithRealData = void 0;
const common_1 = require("@nestjs/common");
const swagger_1 = require("@nestjs/swagger");
const seed_data_result_dto_1 = require("../dto/seed-data-result.dto");
const real_data_seed_config_dto_1 = require("../dto/real-data-seed-config.dto");
const ApiGenerateSeedDataWithRealData = () => (0, common_1.applyDecorators)((0, swagger_1.ApiOperation)({
...
환경변수 EXTERNAL_METADATA_API_URL로 외부 서버를 지정할 수 있습니다.`,
    ...
    type: real_data_seed_config_dto_1.RealDataSeedConfigDto,
    examples: {
        minimalQuick: {
        ...
        withPeriodMulti: {
            ...
            description: '실제 조직 + 평가기간 3개, 분기별/반기별 평가 시뮬레이션',
            value: {
                scenario: 'with_period',
                clearExisting: true,
                projectCount: 10,
        ...
        fullSelfOnly: {
            ...
            description: '자기평가만 완료, 1차/2차 하향평가 미작성 (점수계산 검증용)',
            value: {
                scenario: 'full',
                clearExisting: true,
                projectCount: 2,
        ...
        fullComplete: {
            ...
            description: '실제 조직으로 전체 평가 프로세스 완료 (운영 환경 시뮬레이션)',
            value: {
                scenario: 'full',
                clearExisting: true,
                projectCount: 10,
...
exports.ApiGenerateSeedDataWithRealData = ApiGenerateSeedDataWithRealData;
//# sourceMappingURL=generate-seed-data-with-real-data.decorator.js.map