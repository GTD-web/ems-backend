...
let ProjectAssignmentManagementController = class ProjectAssignmentManagementController {
    ...
    async resetPeriodAssignments(periodId, user) {
        const resetBy = user.id;
        return await this.evaluationCriteriaManagementService.평가기간_전체_할당을_리셋한다(periodId, resetBy);
    }
...
__decorate([
    (0, project_assignment_api_decorators_1.ResetPeriodAssignments)(),
    __param(0, (0, common_1.Param)('periodId', common_1.ParseUUIDPipe)),
    __param(1, (0, decorators_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], ProjectAssignmentManagementController.prototype, "resetPeriodAssignments", null);
__decorate([
