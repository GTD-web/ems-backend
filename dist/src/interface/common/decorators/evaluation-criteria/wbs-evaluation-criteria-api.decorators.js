...
exports.ResetEvaluationCriteriaSubmission = exports.SubmitEvaluationCriteria = exports.DeleteWbsItemEvaluationCriteria = exports.DeleteWbsEvaluationCriteria = exports.UpdateWbsEvaluationCriteria = exports.CreateWbsEvaluationCriteria = exports.UpsertWbsEvaluationCriteria = exports.GetWbsItemEvaluationCriteria = exports.GetWbsEvaluationCriteriaDetail = exports.GetWbsEvaluationCriteriaList = void 0;
const common_1 = require("@nestjs/common");
const swagger_1 = require("@nestjs/swagger");
const wbs_evaluation_criteria_dto_1 = require("../../dto/evaluation-criteria/wbs-evaluation-criteria.dto");
const GetWbsEvaluationCriteriaList = () => (0, common_1.applyDecorators)((0, common_1.Get)(), (0, swagger_1.ApiOperation)({
...
exports.GetWbsEvaluationCriteriaList = GetWbsEvaluationCriteriaList;
const GetWbsEvaluationCriteriaDetail = () => (0, common_1.applyDecorators)((0, common_1.Get)(':id'), (0, swagger_1.ApiOperation)({
...
exports.GetWbsEvaluationCriteriaDetail = GetWbsEvaluationCriteriaDetail;
const GetWbsItemEvaluationCriteria = () => (0, common_1.applyDecorators)((0, common_1.Get)('wbs-item/:wbsItemId'), (0, swagger_1.ApiOperation)({
...
exports.GetWbsItemEvaluationCriteria = GetWbsItemEvaluationCriteria;
const UpsertWbsEvaluationCriteria = () => (0, common_1.applyDecorators)((0, common_1.Post)('wbs-item/:wbsItemId'), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, swagger_1.ApiOperation)({
...
- 다국어 지원: 한글, 영문, 숫자가 혼합된 평가기준 저장 가능`,
    ...
    type: wbs_evaluation_criteria_dto_1.UpsertWbsEvaluationCriteriaBodyDto,
    description: 'WBS 평가기준 저장 데이터 (wbsItemId를 기준으로 자동 생성/수정)',
}), (0, swagger_1.ApiResponse)({
    status: 200,
...
exports.UpsertWbsEvaluationCriteria = UpsertWbsEvaluationCriteria;
const CreateWbsEvaluationCriteria = () => (0, common_1.applyDecorators)((0, common_1.Post)(), (0, common_1.HttpCode)(common_1.HttpStatus.CREATED), (0, swagger_1.ApiOperation)({
    summary: 'WBS 평가기준 생성',
...
exports.CreateWbsEvaluationCriteria = CreateWbsEvaluationCriteria;
const UpdateWbsEvaluationCriteria = () => (0, common_1.applyDecorators)((0, common_1.Put)(':id'), (0, swagger_1.ApiOperation)({
    summary: 'WBS 평가기준 수정',
...
exports.UpdateWbsEvaluationCriteria = UpdateWbsEvaluationCriteria;
const DeleteWbsEvaluationCriteria = () => (0, common_1.applyDecorators)((0, common_1.Delete)(':id'), (0, swagger_1.ApiOperation)({
    summary: 'WBS 평가기준 삭제',
...
exports.DeleteWbsEvaluationCriteria = DeleteWbsEvaluationCriteria;
const DeleteWbsItemEvaluationCriteria = () => (0, common_1.applyDecorators)((0, common_1.Delete)('wbs-item/:wbsItemId'), (0, swagger_1.ApiOperation)({
...
exports.DeleteWbsItemEvaluationCriteria = DeleteWbsItemEvaluationCriteria;
const SubmitEvaluationCriteria = () => (0, common_1.applyDecorators)((0, common_1.Post)('submit'), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, swagger_1.ApiOperation)({
    summary: '평가기준 제출',
...
exports.SubmitEvaluationCriteria = SubmitEvaluationCriteria;
const ResetEvaluationCriteriaSubmission = () => (0, common_1.applyDecorators)((0, common_1.Post)('reset-submission'), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, swagger_1.ApiOperation)({
    summary: '평가기준 제출 초기화',
...
exports.ResetEvaluationCriteriaSubmission = ResetEvaluationCriteriaSubmission;
//# sourceMappingURL=wbs-evaluation-criteria-api.decorators.js.map