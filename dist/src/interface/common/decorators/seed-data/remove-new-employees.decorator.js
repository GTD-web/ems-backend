...
exports.ApiRemoveNewEmployees = void 0;
const common_1 = require("@nestjs/common");
const swagger_1 = require("@nestjs/swagger");
const seed_data_1 = require("../../dto/seed-data");
const ApiRemoveNewEmployees = () => (0, common_1.applyDecorators)((0, swagger_1.ApiOperation)({
...
- 부분 실패: 일부 직원 삭제 실패 시 성공한 직원은 삭제되고 오류 정보 반환`,
    ...
    type: seed_data_1.RemoveNewEmployeesDto,
    examples: {
        basic: {
            summary: '배치 번호로 삭제',
    ...
    type: seed_data_1.RemoveNewEmployeesResultDto,
}), (0, swagger_1.ApiResponse)({
    status: 400,
...
exports.ApiRemoveNewEmployees = ApiRemoveNewEmployees;
//# sourceMappingURL=remove-new-employees.decorator.js.map